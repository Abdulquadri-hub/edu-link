  ...
  <div class="min-h-screen bg-gradient-to-b from-gray-50 to-white py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="max-w-4xl mx-auto mb-8">
      <div class="flex items-center justify-between">
        ...
        <a href="/" class="text-gray-600 hover:text-emerald-600 transition-colors font-semibold flex items-center space-x-2">
    ...
    <!-- Main Container -->
    <div v-if="!registrationComplete" class="max-w-4xl mx-auto">
      <!-- Progress Bar -->
      <div class="mb-8">
          ...
          <div v-for="step in 3" :key="step" class="flex items-center">
            ...
            <div 
              ...
              :class="[
                ...
                currentStep > step ? 'bg-gradient-to-r from-emerald-500 to-teal-600' : 'bg-gray-300'
              ]"
            ></div>
    ...
    <div v-else class="max-w-2xl mx-auto">
      <div class="bg-white rounded-2xl shadow-xl p-12 text-center">
        <!-- Animated Checkmark -->
        <div class="mb-6">
          <div class="mx-auto w-20 h-20 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-full flex items-center justify-center animate-bounce">
